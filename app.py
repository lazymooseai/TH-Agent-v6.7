...
def hae_tapahtumat_api(paikka_id: str, pvm_iso: str) -> list:
    ...
    # KORJAUS: Luodaan oikea 24 tunnin aikaikkuna
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            for t in r.json().get("data", []):
                ...
                # Suodatetaan Pythonissa pois monipäiväisten tapahtumien hälyt
                if t.get("start_time") and not t.get("start_time").startswith(pvm_iso): continue
                if not alku_klo or alku_klo == "00:00": continue
                
                # Suodatetaan duplikaatit
                if nimi in nimet_seen: continue
                nimet_seen.add(nimi)
...
def render_dashboard():
    ...
    with tab1:
        kulttuuri = [
            {"nimi": "Helsingin Kaupunginteatteri (HKT)", "kap": "947 hlö", "hardcoded_id": "tprek:28473", "huomio": "Yleensä ti-su klo 19", "linkki": "https://hkt.fi/kalenteri/"},
            {"nimi": "Kansallisooppera ja baletti", "kap": "1 700 hlö", "hardcoded_id": "tprek:8744", "huomio": "Yleensä ohjelmaa klo 19", "linkki": "https://oopperabaletti.fi/ohjelmisto-ja-liput/"},
            {"nimi": "Musiikkitalo", "kap": "1 704 hlö", "hardcoded_id": "tprek:18874", "huomio": "Konsertit usein klo 19", "linkki": "https://musiikkitalo.fi/tapahtumakalenteri/"}
        ]
