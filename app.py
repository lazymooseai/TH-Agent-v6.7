...
def hae_tapahtumat_api(hakusana: str, pvm_iso: str) -> list:
    ...
    # Huom! 'super_event_type=none' POISTETTU, jotta Oopperan "sarjat" löytyvät.
    # Pyydetään 'include=location', jotta saadaan katutason osoite ja salin nimi.
    params = {
        "text": hakusana,
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            # Sanalista, jolla tunnistetaan Pienet sivunäyttämöt (tuottavat vain vähän kyytejä)
            pieni_keywords = [
            ...
            for t in r.json().get("data", []):
                ...
                # SUODATIN 1: Varmistetaan että osuu tismalleen haetulle päivälle (ei edellisen päivän häntiä)
                if alku_dt.strftime("%Y-%m-%d") != pvm_iso: continue
                    
                # SUODATIN 2: Näyttely-tappaja. Yli 14h kestävät tapahtumat ovat näyttelyitä, ei näytöksiä.
                if loppu_dt:
                ...
                # Ohitetaan 00:00 alkavat pelkät infopläjäykset
                ...
                if is_pieni:
                    # Harmaa teksti ja pienempi fontti piilotetuille/sivusaleille, MUKAAN LUKIEN Arena-näyttämö
                    tulos_pieni.append(
                    ...
                    # Kirkas korostus rahaa tuoville päänäyttämöille
                    tulos_paa.append(
